...
Our approach allows to obtain "laws of physics" of an environment, or, more specifically, a sparse {\em Causal Model}\cite{Wong2020} representing the environment's dynamics.
...
Such an approach, however, requires to "guess" the parameter $\lambda$\cite{Luneau2020}.
...
Other approaches involve sparse feature vectors for interpretability \cite{Weinstein,Zhu2017,VandenOord2017,Cha2018,Deng,Liu2018,Javed2019,Rafati2019,Pei2019,Lillicrap2019,Petros2020,Fallah2020}
...
\cite{Johnson2016,Tang2019} learn a causal model jointly with a decoder, but do not evaluate the sparsity.

\cite{Ke2019} implement learning of causal models in the context of Reinforcement Learning, but without a decoder.
