...
A much more convenient way is to either guess the target number of edges in the graph $K(B)$, or the
...
Separate networks, custom gradient for gumbel, gin configuration, modularity, lagrange exponent/square, custom exponential "annealing", number of optimizers
