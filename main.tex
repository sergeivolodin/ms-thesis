...
We want to compute a gradient of $\frac{\partial \mathcal L}{\partial \theta_i}$ for one of the elements $P_i$ The list of methods generally follows \cite{Bengio2013, Weiß2011,Maddison2017} unless stated otherwise.
